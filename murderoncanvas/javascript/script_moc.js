function mocpuzzle_evidence1_press(e) {
    e = e || window.event;
    if (e.keyCode == 13)
    {
        document.getElementById("mocpuzzle_button1").click();
        return false;
    }
    return true;
};

function hide_mocpuzzle_evidence1() {
...
function mocpuzzle_evidence1() {
  ...
  if (e1 == "WHEN IN LOVE AMY TOUCHES HER CHIN" || e1 == "WHENINLOVEAMYTOUCHESHERCHIN") {
  		answer1 = "Correct! Amy couldn't hide this little quirk from Jennifer.";
      hide_mocpuzzle_evidence1();
...
function mocpuzzle_evidence6() {
  ...
  if (e6 == "KYLIE") {
  		answer6 = "Correct! What did Jennifer mean by this? Is Kylie the loser who is going broke? Is she having financial problems?";
...
function show_mochint_1_1() {
  if (document.getElementById("mochint_answer1_1").style.display == "block") {
    document.getElementById("mochint_answer1_1").style.display = "none";
  } else {
    document.getElementById("mochint_answer1_1").style.display = "block";
  }
};

function show_mochint_1_2() {
  if (document.getElementById("mochint_answer1_2").style.display == "block") {
    document.getElementById("mochint_answer1_2").style.display = "none";
  } else {
    document.getElementById("mochint_answer1_2").style.display = "block";
  }
};

function show_mochint_1_3() {
  if (document.getElementById("mochint_answer1_3").style.display == "block") {
    document.getElementById("mochint_answer1_3").style.display = "none";
  } else {
    document.getElementById("mochint_answer1_3").style.display = "block";
  }
};

function show_mochint_1_4() {
  if (document.getElementById("mochint_answer1_4").style.display == "block") {
    document.getElementById("mochint_answer1_4").style.display = "none";
  } else {
    document.getElementById("mochint_answer1_4").style.display = "block";
  }
};

function show_mochint_1_5() {
  if (document.getElementById("mochint_answer1_5").style.display == "block") {
    document.getElementById("mochint_answer1_5").style.display = "none";
  } else {
    document.getElementById("mochint_answer1_5").style.display = "block";
  }
};

function show_mochint_6_1() {
  if (document.getElementById("mochint_answer6_1").style.display == "block") {
    document.getElementById("mochint_answer6_1").style.display = "none";
  } else {
...
function show_mochint_6_2() {
  if (document.getElementById("mochint_answer6_2").style.display == "block") {
    document.getElementById("mochint_answer6_2").style.display = "none";
  } else {
...
function show_mochint_6_3() {
  if (document.getElementById("mochint_answer6_3").style.display == "block") {
    document.getElementById("mochint_answer6_3").style.display = "none";
  } else {
...
function show_mochint_6_4() {
  if (document.getElementById("mochint_answer6_4").style.display == "block") {
    document.getElementById("mochint_answer6_4").style.display = "none";
  } else {
...
function show_mochint_6_5() {
  if (document.getElementById("mochint_answer6_5").style.display == "block") {
    document.getElementById("mochint_answer6_5").style.display = "none";
  } else {
...
function show_mochint_6_6() {
  if (document.getElementById("mochint_answer6_6").style.display == "block") {
    document.getElementById("mochint_answer6_6").style.display = "none";
  } else {
...
function show_mochint_6_7() {
  if (document.getElementById("mochint_answer6_7").style.display == "block") {
    document.getElementById("mochint_answer6_7").style.display = "none";
  } else {
...
function show_mochint_7_1() {
  if (document.getElementById("mochint_answer7_1").style.display == "block") {
    document.getElementById("mochint_answer7_1").style.display = "none";
  } else {
...
function show_mochint_7_2() {
  if (document.getElementById("mochint_answer7_2").style.display == "block") {
    document.getElementById("mochint_answer7_2").style.display = "none";
  } else {
...
function show_mochint_7_3() {
  if (document.getElementById("mochint_answer7_3").style.display == "block") {
    document.getElementById("mochint_answer7_3").style.display = "none";
  } else {
...
function show_mochint_7_4() {
  if (document.getElementById("mochint_answer7_4").style.display == "block") {
    document.getElementById("mochint_answer7_4").style.display = "none";
  } else {
...
function show_mochint_7_5() {
  if (document.getElementById("mochint_answer7_5").style.display == "block") {
    document.getElementById("mochint_answer7_5").style.display = "none";
  } else {
...
function show_mochint_7_6() {
  if (document.getElementById("mochint_answer7_6").style.display == "block") {
    document.getElementById("mochint_answer7_6").style.display = "none";
  } else {
...
function show_mochint_7_7() {
  if (document.getElementById("mochint_answer7_7").style.display == "block") {
    document.getElementById("mochint_answer7_7").style.display = "none";
  } else {
...
function show_mochint_7_8() {
  if (document.getElementById("mochint_answer7_8").style.display == "block") {
    document.getElementById("mochint_answer7_8").style.display = "none";
  } else {
...
function show_mochint_8_1() {
  if (document.getElementById("mochint_answer8_1").style.display == "block") {
    document.getElementById("mochint_answer8_1").style.display = "none";
  } else {
...
function show_mochint_8_2() {
  if (document.getElementById("mochint_answer8_2").style.display == "block") {
    document.getElementById("mochint_answer8_2").style.display = "none";
  } else {
...
function show_mochint_8_3() {
  if (document.getElementById("mochint_answer8_3").style.display == "block") {
    document.getElementById("mochint_answer8_3").style.display = "none";
  } else {
...
function show_mochint_8_4() {
  if (document.getElementById("mochint_answer8_4").style.display == "block") {
    document.getElementById("mochint_answer8_4").style.display = "none";
  } else {
...
function show_mochint_8_5() {
  if (document.getElementById("mochint_answer8_5").style.display == "block") {
    document.getElementById("mochint_answer8_5").style.display = "none";
  } else {
...
function show_mochint_8_6() {
  if (document.getElementById("mochint_answer8_6").style.display == "block") {
    document.getElementById("mochint_answer8_6").style.display = "none";
  } else {
...
function show_mochint_8_7() {
  if (document.getElementById("mochint_answer8_7").style.display == "block") {
    document.getElementById("mochint_answer8_7").style.display = "none";
  } else {
...
function show_mochint_9_1() {
  if (document.getElementById("mochint_answer9_1").style.display == "block") {
    document.getElementById("mochint_answer9_1").style.display = "none";
  } else {
...
function show_mochint_9_2() {
  if (document.getElementById("mochint_answer9_2").style.display == "block") {
    document.getElementById("mochint_answer9_2").style.display = "none";
  } else {
...
function show_mochint_9_3() {
  if (document.getElementById("mochint_answer9_3").style.display == "block") {
    document.getElementById("mochint_answer9_3").style.display = "none";
  } else {
...
function show_mochint_9_4() {
  if (document.getElementById("mochint_answer9_4").style.display == "block") {
    document.getElementById("mochint_answer9_4").style.display = "none";
  } else {
...
function show_mochint_9_5() {
  if (document.getElementById("mochint_answer9_5").style.display == "block") {
    document.getElementById("mochint_answer9_5").style.display = "none";
  } else {
...
function show_mochint_9_6() {
  if (document.getElementById("mochint_answer9_6").style.display == "block") {
    document.getElementById("mochint_answer9_6").style.display = "none";
  } else {
